...
class Plant(turtle.Turtle):
    ...
    def reap_plant(self):
        self.clear()
        self.hideturtle()
        print(self.ripeness, "points gained from this plant")  # выводим в консоль очки за собранный овощ, равные спелости
        return self.ripeness #возвращаем величину спелости (ripeness)
        del self
